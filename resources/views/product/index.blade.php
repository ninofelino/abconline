...
@section('content')
    <div class="container">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>d</th><th>Barcode</th><th>Category</th><th>Gambar</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
       ...
       ?>                                   <br>
                                              <h3>{{$item->style}}</h3>
                                            <br>
                                            <img src="{{asset('images/'.$item->gambar)}}" style="max-height: 200px">

                                        </td>
                                        <td>{{ $item->barcode }}</td><td>{{ $item->category }}</td><td></td>
                                        <td>
